...
function Navbar() {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="/">SpaceX Application</a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto ms-5 mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink className="nav-link"  aria-current="page" to="/">Launches</NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link"  aria-current="page" to="/Rocket">Rockets</NavLink>
        </li>
      </ul>
